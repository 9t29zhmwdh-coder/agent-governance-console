...
[![CI](https://github.com/9t29zhmwdh-coder/agent-governance-console/actions/workflows/ci.yml/badge.svg)](https://github.com/9t29zhmwdh-coder/agent-governance-console/actions) [![CodeQL](https://github.com/9t29zhmwdh-coder/agent-governance-console/actions/workflows/github-code-scanning/codeql/badge.svg)](https://github.com/9t29zhmwdh-coder/agent-governance-console/security/code-scanning) [![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/9t29zhmwdh-coder/agent-governance-console/badge)](https://securityscorecards.dev/viewer/?uri=github.com/9t29zhmwdh-coder/agent-governance-console) [![OpenSSF Best Practices](https://www.bestpractices.dev/projects/13719/badge)](https://www.bestpractices.dev/projects/13719)
...
> **How it runs:** AGC is not a hosted service and not a desktop app. `agc-api` is a small REST API server you run yourself with `cargo run`, on `127.0.0.1:8080` by default. There is no installer and nothing runs in the background; you start and stop the process yourself. Open `http://127.0.0.1:8080/dashboard` in a browser for a lightweight UI over the same API.
